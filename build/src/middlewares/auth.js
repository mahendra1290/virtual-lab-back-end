...
function isAuthenticated(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, split, token, auth, decodedToken, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    req.auth = __assign(__assign({}, res.locals), { uid: decodedToken.uid, role: decodedToken.role, email: decodedToken.email });
